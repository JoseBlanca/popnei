...
export class Variants {
   ...
   *
   * Every call of `iterBlocks` after it throws, and so does every read of
   * `steps`. The names of the individuals and the ploidy still answer: they
   * are in JavaScript. A second call is not an error: it has nothing left
   * to give back.
   */
  free(): void {
    this.#source?.free();
