...
/// G''_ST.
///
/// The package refuses a measure that is not in this list and names the
/// ones that are in the refusal, so that a measure written into the core is
/// reachable from TypeScript by that one change.
#[wasm_bindgen]
#[must_use]
