...
///
/// The package refuses the other two, the chord distance and Nei's D_A, by
/// this list and names these in the refusal, so that the measures work
/// package 3 of `docs/plans/dists-pops.md` adds are added in the core
/// alone.
#[wasm_bindgen]
#[must_use]
